...
const FooterSection = () => {
    return (
        <footer className="border-t border-white/5 bg-[#0B1121] pt-12 md:pt-20 pb-8 md:pb-10 px-4 sm:px-6 mt-12 md:mt-20 relative z-10">
            <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 mb-10 md:mb-16">
                {/* Left Column: Brand */}
            ...
            <div className="max-w-[1200px] mx-auto pt-6 md:pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
