  ...
  return (
    <div className="min-h-screen bg-[#0B1121] text-slate-300 font-sans selection:bg-sky-500/30 relative overflow-x-hidden flex flex-col">
      ...
      <div className="relative z-10 flex flex-col flex-1">
        ...
        <main className="flex-1 px-4 sm:px-6 py-8 md:py-12 mx-auto max-w-7xl w-full">
          ...
          <div className="mb-8 md:mb-10 flex flex-col gap-4 md:gap-6 md:flex-row md:items-end md:justify-between border-b border-white/5 pb-6 md:pb-8">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span className="hidden xs:inline">Add Credential</span><span className="xs:hidden">Add</span>
              </Button>
            </div>
          </div>
          ...
          {credentialsMetaData?.length === 0 ? (
            ...
            <div className="grid gap-3 md:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
              {credentialsMetaData?.map((cred) => (
                ...
                >
                  <CardContent className="flex items-center justify-between gap-3 sm:gap-4 py-4 sm:py-5 px-4 sm:px-6">
        ...
        {deleting && currentCred && (
          <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
            ...
            <div className="relative z-10 w-full max-w-md bg-[#1e293b] rounded-2xl shadow-2xl border border-white/10 p-4 sm:p-6 animate-in fade-in zoom-in-95 duration-200">
