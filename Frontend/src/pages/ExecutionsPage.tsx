    ...
    <div className="min-h-screen bg-[#0B1121] text-slate-300 font-sans selection:bg-sky-500/30 relative">
      ...
      <div className="relative z-10">
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 py-8 md:py-12">
          ...
          <div className="mb-8 md:mb-10 border-b border-white/5 pb-6 md:pb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-white tracking-tight mb-2">Executions</h2>
